...
- Rename the base package `clean` to your preferred name. *[How to]*
...
```java
import clean.domain.executor.Executor;
import clean.domain.executor.MainThread;
import clean.domain.interactors.WelcomingInteractor;
import clean.domain.interactors.base.AbstractInteractor;
import clean.domain.repository.MessageRepository;
```
